...
Germ7 = 1
U07 = -0.280
I7 = [0.25,0.5,0.75,1,1.25,1.5]
U7 = [-3.04, -5.87, -8.38, -10.64, -12.82, -14.1]
...
for i in range(5,6):
    a,b,k = fun(total_B[i],total_U[i])
    plt.errorbar(total_B[i], total_U[i], yerr = 0.1, xerr = errors_B[i], fmt='o',label = str(Germs[i]) + 'A; k = ' + str(a)[0:5],color = colors[i] )   #U(B)
