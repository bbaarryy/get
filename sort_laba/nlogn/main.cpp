...
int main(){
    //print_data("data_merging.txt", 0);
    //print_data("data_heap.txt",1);
    //print_data("data_quick.txt",2);

    best_data("data_merging_b.txt", 0);
    best_data("data_quick_b.txt",2);
    best_data("data_heap_b.txt",1);

    worst_data("data_merging_w.txt", 0);
    worst_data("data_heap_w.txt",1);
    worst_data("data_quick_w.txt",2);
