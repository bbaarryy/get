...
file1 = open("./physic_labs/2.2.1/1_40.9.csv", "r")
file2 = open("./physic_labs/2.2.1/2_78.csv", "r")
file3 = open("./physic_labs/2.2.1/3_121.9.csv", "r")
file4 = open("./physic_labs/2.2.1/4_159.7.csv", "r")

names = ["40.9 мм рт ст", "78 мм рт ст", "121.9 мм рт ст", "159.7 мм рт ст"]
